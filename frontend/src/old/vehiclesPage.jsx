...
//       toast.error(
//         err.response?.data?.detail || "Failed to fetch vehicle details",
//       );
//     } finally {
//       setFetching(false);
//     }
...
//             {existingVehicle.registration_number} is already in your fleet with
//             valid documents.
//           </p>
...
//         <div className="grid grid-cols-2 gap-3">
//           <Card
//             className={`border-l-4 border-l-blue-500 ${getDaysLeftColor(insuranceDays)}`}
//           >
...
//                   Expires:{" "}
//                   {new Date(fetchedData.insurance_expiry).toLocaleDateString()}
//                 </p>
//               )}
//             </CardContent>
//           </Card>
...
//           <Card
//             className={`border-l-4 border-l-emerald-500 ${getDaysLeftColor(pucDays)}`}
//           >
//             <CardContent className="p-3">
//               <div className="flex items-center justify-between">
//                 <div className="flex items-center gap-2">
...
//                 <p className="text-xs text-slate-500 mt-1">
//                   Expires:{" "}
//                   {new Date(fetchedData.puc_expiry).toLocaleDateString()}
//                 </p>
//               )}
//             </CardContent>
//           </Card>
...
//                 {fetchedData.chassis_number || "N/A"}
//               </p>
//             </div>
//             <div>
//               <p className="text-xs text-slate-500">Engine Number</p>
//               <p className="font-mono text-xs">
//                 {fetchedData.engine_number || "N/A"}
//               </p>
//             </div>
//             <div>
...
//                 onChange={(e) =>
//                   setFetchedData({ ...fetchedData, site_name: e.target.value })
//                 }
//               />
//             </div>
//             <div>
...
//                 onChange={(e) =>
//                   setFetchedData({ ...fetchedData, remark: e.target.value })
//                 }
//               />
//             </div>
//           </div>
...
//                 setFetchedData({ ...fetchedData, file_status: checked })
//               }
//             />
//             <Label className="text-xs text-slate-500">
//               Mark as File Complete
//             </Label>
//           </div>
//         </div>
...
//           Enter vehicle registration number to auto-fetch details from Surepass
//           API
//         </p>
...
//           <Select value={taxType} onValueChange={(value) => setTaxType(value)}>
//             <SelectTrigger>
//               <SelectValue />
//             </SelectTrigger>
//             <SelectContent>
...
//             onChange={(e) =>
//               setFormData({ ...formData, average_kmpl: e.target.value })
//             }
//             placeholder="15"
//           />
//         </div>
...
//           onCheckedChange={(checked) =>
//             setFormData({ ...formData, file_status: checked })
//           }
//         />
...
//     >
//       <Card
//         className={`group relative border-slate-200 hover:border-emerald-200 hover:shadow-lg transition-all duration-300 overflow-hidden ${vehicle.sold ? "opacity-75 bg-slate-50" : ""}`}
//       >
//         {/* Status Indicator Bar */}
//         <div
//           className={`absolute top-0 left-0 w-1 h-full ${vehicle.file_status ? "bg-emerald-500" : "bg-amber-500"}`}
//         />
...
//                 <Badge
//                   className={`${getStatusColor(insuranceDays)} text-white`}
//                 >
...
//         `/vehicles/${localVehicleData.id}/upload-rc`,
//         formData,
//         {
...
//       toast.error(
//         error.response?.data?.detail || "Failed to upload RC document",
//       );
//     } finally {
...
//     } catch (error) {
//       toast.error(
//         error.response?.data?.detail || "Failed to delete RC document",
//       );
//     }
//   };
...
//       const document = localVehicleReport?.documents?.find(
//         (d) => d.id === documentId,
//       );
...
//     try {
//       await api.delete(
//         `/vehicles/${localVehicleData.id}/delete-document/${documentId}`,
//       );
...
//       toast.error(
//         error.response?.data?.detail ||
//           `Failed to delete ${documentType} document`,
//       );
//     }
//   };
...
//         [
//           "Average Mileage",
//           localVehicleData.average_kmpl
//             ? `${localVehicleData.average_kmpl} km/l`
//             : "N/A",
//         ],
//         [
//           "Tank Capacity",
//           localVehicleData.tank_capacity_liters
//             ? `${localVehicleData.tank_capacity_liters} L`
//             : "N/A",
//         ],
...
//         [
//           "File Status",
//           localVehicleData.file_status ? "Complete" : "Incomplete",
//         ],
//       ];
...
//           return [
//             docItem.document_type === "Custom"
//               ? docItem.custom_document_name || "Custom"
//               : docItem.document_type,
//             docItem.provider || "N/A",
//             docItem.policy_number || "N/A",
//             docItem.issue_date
//               ? new Date(docItem.issue_date).toLocaleDateString()
//               : "N/A",
//             docItem.expiry_date
//               ? new Date(docItem.expiry_date).toLocaleDateString()
//               : "N/A",
//             status,
...
//       // Save PDF
//       doc.save(
//         `${localVehicleData.registration_number.replace(/[^a-zA-Z0-9]/g, "_")}_full_report_${new Date().toISOString().split("T")[0]}.pdf`,
//       );
...
//               {localVehicleData.type}
//             </Badge>
//             <Badge variant="outline" className="bg-slate-100">
//               {localVehicleData.fuel_type}
//             </Badge>
...
//                 {localVehicleData.insurance_expiry &&
//                   getStatusBadge(
//                     getDaysLeft(localVehicleData.insurance_expiry),
//                   )}
//               </CardContent>
//             </Card>
...
//                 Documents ({localVehicleReport?.documents?.length || 0})
//               </TabsTrigger>
//               <TabsTrigger value="challans">
//                 Challans ({localVehicleReport?.challans?.length || 0})
//               </TabsTrigger>
//               <TabsTrigger value="services">
//                 Services ({localVehicleReport?.services?.length || 0})
//               </TabsTrigger>
//               <TabsTrigger value="fastag">
//                 FASTag ({localFastagPasses?.length || 0})
//               </TabsTrigger>
//               <TabsTrigger value="accidents">
//                 Accidents ({localVehicleReport?.accidents?.length || 0})
//               </TabsTrigger>
//             </TabsList>
...
//                         <p className="text-xs text-slate-500">Chassis Number</p>
//                         <p className="font-mono text-xs">
//                           {localVehicleData.chassis_number || "N/A"}
//                         </p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-slate-500">Engine Number</p>
//                         <p className="font-mono text-xs">
//                           {localVehicleData.engine_number || "N/A"}
//                         </p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-slate-500">Color</p>
...
//                         {localVehicleData.average_kmpl || "N/A"}{" "}
...
//                       <p className="text-xl font-bold">
//                         {localVehicleData.tank_capacity_liters || "N/A"}{" "}
//                         <span className="text-sm font-normal text-slate-500">
//                           L
//                         </span>
//                       </p>
...
//                         </p>
//                         <p>
//                           {localVehicleData.date_of_registration
//                             ? new Date(
//                                 localVehicleData.date_of_registration,
//                               ).toLocaleDateString()
//                             : "N/A"}
...
//                             onClick={() => {
//                               const input =
//                                 document.getElementById("rc-upload");
...
//                       <span className="text-sm font-medium">
//                         {localVehicleData.fastag_company || "N/A"}
//                       </span>
//                     </div>
//                     <div className="flex items-center justify-between">
...
//                       <span className="text-sm font-medium">
//                         ₹
//                         {localVehicleData.fastag_balance?.toLocaleString() ||
//                           "0"}
//                       </span>
//                     </div>
//                     <div className="flex items-center justify-between">
...
//                     This vehicle has no documents yet.
//                   </p>
//                 </div>
//               ) : (
//                 <div className="space-y-3">
...
//                                   if (
//                                     ref &&
//                                     documentFileInputRefs[doc.id] !== ref
//                                   ) {
//                                     setDocumentFileInputRefs((prev) => ({
//                                       ...prev,
//                                       [doc.id]: ref,
//                                     }));
//                                   }
...
//                   </h3>
//                   <p className="text-sm text-slate-500">
//                     This vehicle has no traffic violation records.
//                   </p>
//                 </div>
//               ) : (
//                 <div className="space-y-3">
...
//                           <div className="flex items-start gap-3">
//                             <div
//                               className={`p-2 rounded-lg ${challan.status === "Paid" ? "bg-emerald-100" : "bg-rose-100"}`}
//                             >
//                               {challan.status === "Paid" ? (
//                                 <CheckCircle
//                                   size={20}
...
//                   </h3>
//                   <p className="text-sm text-slate-500">
//                     This vehicle has no service history.
//                   </p>
//                 </div>
//               ) : (
//                 <div className="space-y-3">
...
//                                 {service.odometer_reading} km
//                               </p>
//                             </div>
//                           </div>
//                           <div className="text-right">
//                             <p className="text-lg font-bold text-purple-600">
//                               ₹{service.total_cost?.toLocaleString() || "0"}
//                             </p>
//                           </div>
//                         </div>
//                       </CardContent>
...
//                   </h3>
//                   <p className="text-sm text-slate-500">
//                     Add passes for toll plaza access.
//                   </p>
//                 </div>
//               ) : (
//                 <div className="space-y-3">
...
//                                 <Badge
//                                   className={
//                                     accident.claim_status === "Settled"
//                                       ? "bg-emerald-100 text-emerald-700"
//                                       : accident.claim_status === "Approved"
//                                         ? "bg-blue-100 text-blue-700"
//                                         : "bg-amber-100 text-amber-700"
//                                   }
//                                 >
...
//                               ₹
//                               {(accident.damage_estimate || 0).toLocaleString()}
//                             </p>
//                           </div>
//                         </div>
//                       </CardContent>
...
//         <AlertDialog
//           open={showRcDeleteDialog}
//           onOpenChange={setShowRcDeleteDialog}
//         >
//           <AlertDialogContent>
//             <AlertDialogHeader>
...
//                   This action cannot be undone. The RC document will be
...
//                     </p>
//                     <p className="text-sm text-slate-600">
//                       {documentToDelete.policy_number}
//                     </p>
//                     {localVehicleData && (
//                       <p className="text-xs text-slate-500 mt-1">
...
//                 )}
//                 <p className="text-sm text-rose-600 font-medium mt-2">
//                   This action cannot be undone. The document file will be
//                   permanently deleted.
//                 </p>
//               </AlertDialogDescription>
//             </AlertDialogHeader>
...
//       toast.success(
//         `Vehicle ${!currentStatus ? "marked as sold" : "marked as active"}`,
//       );
...
//       toast.error(
//         error.response?.data?.detail || "Failed to update sold status",
//       );
//     } finally {
...
//         tank_capacity_liters:
//           freshVehicle.tank_capacity_liters?.toString() || "",
...
//         date_of_registration: freshVehicle.date_of_registration
//           ? freshVehicle.date_of_registration.split("T")[0]
//           : "",
...
//           ? new Date(formData.insurance_expiry).toISOString()
//           : null,
//         puc_expiry: formData.puc_expiry
//           ? new Date(formData.puc_expiry).toISOString()
//           : null,
//         fit_up_to: formData.fit_up_to
//           ? new Date(formData.fit_up_to).toISOString()
//           : null,
//       };
...
//     try {
//       const response = await api.post(
//         `/vehicles/${selectedVehicle.id}/sync-documents`,
//       );

//       if (response.data.documents_created.length > 0) {
//         toast.success(
//           `Updated ${response.data.documents_created.join(" and ")} document(s)`,
//         );
...
//         toast.success(
//           `✅ Imported ${response.data.challans_imported} new challans`,
//         );

//         // Show summary of what was imported if 5 or fewer challans
//         if (
//           response.data.challans_imported <= 5 &&
//           response.data.challans.length > 0
//         ) {
...
//         toast.info(
//           `📋 Found ${response.data.challans_found} challans, but all already exist in the system`,
//         );
//       } else {
...
//     pendingDocs: vehicles.filter((v) => !v.insurance_expiry && !v.puc_expiry)
//       .length,
//   };
...
//           <Dialog
//             open={surepassDialogOpen}
//             onOpenChange={setSurepassDialogOpen}
//           >
...
//               <Button
//                 onClick={() => setSurepassDialogOpen(true)}
//                 className="bg-blue-600 hover:bg-blue-700"
//               >
...
//                     ? Math.ceil(
//                         (new Date(vehicle.puc_expiry) - new Date()) /
//                           (1000 * 60 * 60 * 24),
//                       )
//                     : null;
...
//                             onClick={() =>
//                               handleSoldStatusToggle(vehicle.id, vehicle.sold)
//                             }
...
//                 onChange={(e) =>
//                   setPassForm({ ...passForm, pass_name: e.target.value })
//                 }
//               />
//             </div>
//             <div>
...
//                 onChange={(e) =>
//                   setPassForm({ ...passForm, toll_plaza: e.target.value })
//                 }
//               />
//             </div>
//             <div>
...
//                 onChange={(e) =>
//                   setPassForm({ ...passForm, trips_allowed: e.target.value })
//                 }
//               />
//             </div>
//             <div>
...
//                 onChange={(e) =>
//                   setPassForm({ ...passForm, balance_trips: e.target.value })
//                 }
//               />
//             </div>
//             <div className="grid grid-cols-2 gap-4">
...
//                   onChange={(e) =>
//                     setPassForm({ ...passForm, issue_date: e.target.value })
//                   }
//                 />
//               </div>
//               <div>
...
//                   onChange={(e) =>
//                     setPassForm({ ...passForm, expiry_date: e.target.value })
//                   }
//                 />
//               </div>
//             </div>
...
//                   <SelectItem value="After RC Update">
//                     After RC Update
//                   </SelectItem>
//                 </SelectContent>
//               </Select>
...
//               )}
//               <p className="text-sm text-rose-600 font-medium mt-2">
//                 This action cannot be undone. All associated data (documents,
//                 challans, services, etc.) will be permanently deleted.
//               </p>
//             </AlertDialogDescription>
//           </AlertDialogHeader>
//           <AlertDialogFooter>
...
//                 <>
//                   <p>
//                     Are you sure you want to fetch challans for this vehicle?
//                   </p>
